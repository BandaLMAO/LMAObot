...
module.exports = async bot => {
    console.log(`${bot.user.username} is available now!Test it xD!`)
    var servers = [ `${bot.guilds.cache.size} servers`, `${bot.users.cache.size} users!` ], i = 0;
    setInterval(() => bot.user.setActivity(`${PREFIX}help | ${servers[i++ % servers.length]}`, { type: "WATCHING" }),30000)
